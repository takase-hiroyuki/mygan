...
btnProcessSelf?.addEventListener('click', async () => {
    writeLog(supabase, getLocalPlayerName(), "Action", "「処理する」ボタンが押下されました");
    ...
    await actionProcessSelf(supabase, currentUserId, qty);
});
